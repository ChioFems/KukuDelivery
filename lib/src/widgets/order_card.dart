        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("assets/images/baby-chicken.jpg"),
                  fit: BoxFit.cover,
                ),
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                Text("Chick", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16.0),),
                SizedBox(height: 5.0),
                Text("2000", style: TextStyle(color: Theme.of(context).primaryColor, fontWeight: FontWeight.bold),),
                SizedBox(height: 5.0),
                Container(
                  height: 25.0,
                  width: 120.0,
                  child: ListView(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Row(
                          children: <Widget>[
                            Text("Broiler", style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold),),
                            SizedBox(width: 5.0),
                            InkWell(
                              onTap: (){},
